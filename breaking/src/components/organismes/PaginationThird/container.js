...
import PaginationThird from "./component";

const PaginationThirdContainer = () => {
  ...
  return (
    <PaginationThird
      ...
      setCurrentButtonPagination={setCurrentButtonPagination}
...
export const container = PaginationThirdContainer;
